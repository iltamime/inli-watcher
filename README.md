...
Version GitHub Actions : fait UNE seule vérification puis s'arrête
(c'est GitHub qui le relance automatiquement toutes les 5 minutes).
"""
...
def fetch_listings_for_department(dept_slug):
    ...
    while True:
        ...
        try:
            ...
            print(f"  [!] Erreur réseau sur {dept_slug} page {page}: {e}")
            break
